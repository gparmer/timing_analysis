...
public final class Distribution {
	...
	/**
	 * Return a integer number from an exponential distribution with rate lambda.
	 */
	public static int my_exp(double lambda) {
//		Original one, but I need integer P here . So use the following code
		Random random = new Random();
        double scale = 10.0;
        int result = (int) (-scale * Math.log(random.nextDouble()));
        return result;
	}
	 ...
	 * Integer.parseInt(args[0]); if (args.length == 2)
	 * Distribution.setSeed(Long.parseLong(args[1])); double[] t = { .5, .3, .1,
	 * .1 };
	 * 
	 * System.out.println("seed = " + Distribution.getSeed()); for (int i = 0; i
	 * < N; i++) { System.out.printf("%2d " , uniform(100));
	 * System.out.printf("%8.5f ", uniform(10.0, 99.0));
	 * System.out.printf("%5b " , bernoulli(.5)); System.out.printf("%7.5f ",
	 * gaussian(9.0, .2)); System.out.printf("%7.5f ", exp(10));
	 * System.out.printf("%2d " , discrete(t)); System.out.println(); }
	 * 
